...
class CreateMatchController {
    constructor($scope, $http, $state, PATHS, LoginService, toaster, $ionicLoading, Canchas) {
        this.$http = $http;
        this.$state = $state;
        this.PATHS = PATHS;
...
CreateMatchController.$inject = ['$scope', '$http', '$state', 'PATHS', 'LoginService', 'toaster', '$ionicLoading', 'Canchas'];
